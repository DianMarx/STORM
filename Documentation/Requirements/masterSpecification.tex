...
\input{./subsections/modularization.tex}
\subsection{Architectural tactics addressing quality requirements}
\input{./subsections/architecturalTactics.tex}
\subsection{Architectural Components}
\input{./subsections/architecturalComponents.tex}
